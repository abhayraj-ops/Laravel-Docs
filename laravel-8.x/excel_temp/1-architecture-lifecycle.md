...
If you want to read more about export objects, go to the architecture page of [export objects](https://docs.laravel-excel.com/3.1/architecture/objects.html).
...
Read more about the exportable trait in the [exportables](https://docs.laravel-excel.com/3.1/exports/exportables.html) docs.
...
If you want to read more about imports objects, go to the architecture page of [imports objects](https://docs.laravel-excel.com/3.1/architecture/objects.html).
...
Read more about the importable trait in the [importables](https://docs.laravel-excel.com/3.1/imports/importables.html) docs.
