...
**URL:** https://docs.laravel-excel.com/3.1/imports/validation.html
...
# Row Validation
  ...
  - Handling validation errorsDatabase transactionsGathering all failures at the endSkipping failures
  - Skipping empty rows
  - Extend empty rows logicSkipping errors
