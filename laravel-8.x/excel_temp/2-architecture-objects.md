...
# Import & Export Objects
  ...
  - Plain Old PHP ObjectConstructorSettersGetters
  - Concerns
  - Hooks
...
.
âââ app
âÂ Â  âââ Exports (Groups all exports in your app)
âÂ Â  âÂ Â  âââ UsersExport.php
âÂ Â  âÂ Â  âââ ProductsExport.php
âÂ Â  âÂ Â  âââ Sheets (You can group sheets together)
âÂ Â  âÂ Â     âââ InactiveUsersSheet.php
âÂ Â  âÂ Â     âââ ActiveUsersSheet.php
|   |
âÂ Â  âââ Imports (Groups all imports in your app)
âÂ Â  âÂ Â  âââ UsersImport.php
âÂ Â  âÂ Â  âââ ProductsImport.php
âÂ Â  âÂ Â  âââ Sheets (You can group sheets together)
âÂ Â  âÂ Â     âââ OutOfStockProductsSheet.php
âÂ Â  âÂ Â     âââ ProductsOnSaleSheet.php
âÂ 
âââ composer.json
```
...
Read more about Concerns in the [concerns documentation](https://docs.laravel-excel.com/3.1/architecture/concerns.html).
