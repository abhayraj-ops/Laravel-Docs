# Importing to models | Laravel Excel

**URL:** https://docs.laravel-excel.com/3.1/imports/model.html
...
# Importing to models
  ...
  - Upserting modelsUpserting with specific columns
  - Skipping duplicate rows
  - Skipping specific rows
  - Possible column names
  - Cascading relation persistence
  - Handling persistence on your ownMacro's and Mixins
