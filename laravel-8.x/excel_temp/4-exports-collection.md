...
**URL:** https://docs.laravel-excel.com/3.1/exports/collection.html
...
# Exporting collections
  ...
  - Collection macrosDownloading a collection as ExcelStoring a collection on disk
...
ð¡ More about storing exports can be found in the [storing exports on disk page](https://docs.laravel-excel.com/3.1/exports/store.html).

If you want to use relationships in Collection, combine with [Mapping Data](https://docs.laravel-excel.com/3.1/exports/mapping.html)
