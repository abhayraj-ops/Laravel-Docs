# Queued | Laravel Excel

**URL:** https://docs.laravel-excel.com/3.1/exports/queued.html
...
Queued exportables are processed in chunks; each chunk being a job pushed to the queue by the `QueuedWriter`. In case of exportables that implement the [FromQuery](https://docs.laravel-excel.com/3.1/exports/from-query.html) concern, the number of jobs is calculated by dividing the `$query->count()` by the chunk size.
