...
**URL:** https://docs.laravel-excel.com/3.1/exports/extending.html
...
# Extending
  ...
  - Custom Concerns
  - MacroableWriterSheetCustomizeRTL (Right to Left) Sheets
...
ð¡ `::extend` accepts a callable as second parameter. It's also possible to pass a closure.
