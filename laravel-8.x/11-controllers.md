...
**Dependencies**:
- `App\Repositories\UserRepository` - Custom repository for user data access
...
**Dependencies**:
- `Illuminate\Http\Request` - HTTP request instance
- `Illuminate\Http\RedirectResponse` - Redirect response type
